...
namespace BLL.Services
{
    public class MessageServices
    {
        ...
        public static List<InvestorMessageModel> Conversation(string email, string myemail)
        {
            var data = DataAccessFactory.MessageByEmailccess().Conversetion(myemail, email);
            var messages = new List<InvestorMessageModel>();
