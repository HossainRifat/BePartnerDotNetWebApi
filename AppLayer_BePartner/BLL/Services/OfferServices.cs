    ...
    public class OfferServices
    {
        public static List<OfferModel> Get()
        {
            ...
            foreach (var item in data)
            {
                ...
                var In = InvestorService.Get(item.In_Email);
        ...
        public static List<OfferModel> getByCompany(string id)
        {
            var data = DataAccessFactory.OfferMoreDataAccess().getByCOmpanyId(id);
            var offers = new List<OfferModel>();
        ...
        public static List<OfferModel> mySentOfferByCompany(string companyId, string email)
        {
            var data = DataAccessFactory.OfferMoreDataAccess().MySentOfferByCompany(companyId, email);
            var offers = new List<OfferModel>();
