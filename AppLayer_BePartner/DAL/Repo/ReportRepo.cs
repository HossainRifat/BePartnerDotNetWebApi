...
namespace DAL.Repo
{
    internal class ReportRepo : AD_IRepo<Report, int> , Report_IRepo<Report, string>
    {
        ...
        public List<Report> sortByIdInc()
        {
            var REPO = (from I in db.Reports orderby I.ReportId ascending select I).ToList();
            return REPO;
        }

        public List<Report> sortByIdDec()
        {
            var REPO = (from I in db.Reports orderby I.ReportId descending select I).ToList();
            return REPO;
        }
    }
}
