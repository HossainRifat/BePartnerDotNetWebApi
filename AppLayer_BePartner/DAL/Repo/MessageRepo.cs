...
namespace DAL.Repo
{
    internal class MessageRepo : In_IRepo<Message, int>, In_MsgRepo<Message, string>
    {
        ...
        public List<Message> Conversetion(string myemail, string email)
        {
            var msgs = (from I in db.Messages where (I.Sender.Equals(myemail) && I.Receiver.Equals(email)) || (I.Sender.Equals(email) && I.Receiver.Equals(myemail)) select I).ToList();
            return msgs;
        }
        ...
        {
            var msgs = (from I in db.Messages where I.Sender.Equals(email) || I.Receiver.Equals(email) orderby I.MsgId descending select I).ToList();
            return msgs;
        }
