...
namespace DAL.Repo
{
    internal class InvestorRepo : In_IRepo<Investor, string>, In_VarIRepo<Investor, string>
    {
        ...
        {
            var Ed = (from I in db.Investors where I.In_Email.Equals(email) && !I.EmailValidation.Equals("Yes") select I).FirstOrDefault();
            if(Ed != null)
            {
                return true;
            }
